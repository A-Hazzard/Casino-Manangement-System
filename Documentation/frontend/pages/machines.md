...
**Components:**
- `components/cabinets/CabinetsNavigation.tsx` - Tab navigation component
...
**API Endpoint:**
- Chart data aggregated from multiple machine chart endpoints (handled internally)

**Data Flow:**
1. Chart data fetched and aggregated for all cabinets
2. Data filtered by time period, licensee, and currency
3. Chart displays time-series data

**Key Functions:**
- Chart data managed via `useDashBoardStore` (`chartData`, `loadingChartData`)
...
2. Stats displayed in widget with online/offline counts
...
**Components:**
- `components/cabinets/CabinetSearchFilters.tsx` - Search and filter component
