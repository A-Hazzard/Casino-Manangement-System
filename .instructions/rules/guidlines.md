...
"Licencee/location-based filtering for data according to user context"
]
...
rule("Frontend code must never import React namespace.") {
  ...
  rationale: "Modern React with JSX transform doesn't require React import; direct imports are cleaner and more explicit."
  hooks: [
  "useState", "useEffect", "useCallback", "useMemo", "useRef", "useContext",
  "forwardRef", "memo", "Children", "createContext", "Fragment"
  ]
  types: [
  "FC", "FunctionComponent", "ChangeEvent", "MouseEvent", "KeyboardEvent",
  "FormEvent", "RefObject", "MutableRefObject", "ReactNode", "ReactElement",
  "ElementRef", "ComponentPropsWithoutRef", "CSSProperties"
  ]
}
...
rule("Licencee/location-based filtering is required for all appropriate backend queries.") {
appliesTo: "app/api/\*_/_.ts"
snippet("""
