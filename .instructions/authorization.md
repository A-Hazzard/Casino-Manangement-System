...
| ------------------------------------------------------ | -------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `GET /api/collection-reports/[reportId]`               | `accountingDetails.ts` → `getCollectionReportById`                         | `getReviewerScale` → all `locationMetrics`, `sasMetrics`, and per-machine `scaleMachineValues`                               |
