...
- _Note: For this test, let's say the cashier just logs the payout. The EOD report tracks total payouts._
...
- **Net Flow:** $21,500
  - _Note: Net flow might not include the reconciliation variance depending on how the frontend calculates `metrics.totalInflows - metrics.totalOutflows`. The $100 loss isn't strictly an "outflow" transaction, it's a variance._
- **Expenses:** $500
- **Payouts:** $2,000
- **Variance:** -$100
...
- **Total Value:** $71,400
- _(The exact count of $100s, $50s, etc., should mathematically equal $71,400 based on the net exchanges)._
