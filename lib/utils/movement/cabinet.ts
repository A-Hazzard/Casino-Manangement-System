/**
 * Machine Movement Calculation Utility
 *
 * Utility functions for calculating movement values for machines in collection modals.
 * Provides the same movement calculation logic as the backend to ensure consistency
 * between frontend validation and backend creation.
 *
 * Features:
 ...
 * - Gross calculation
 *
 * Used in collection report modals for validating machine entry calculations.
 */
 ...
 */
export function calculateCabinetMovement(
  metersIn: number,
  metersOut: number,
  prevIn: number,
  prevOut: number,
