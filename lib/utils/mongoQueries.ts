 ...
 */
export function generateQuery(type: keyof typeof MONGO_QUERIES, query: string, params?: Record<string, string>): string {
  const baseQuery = MONGO_QUERIES[type][query as keyof typeof MONGO_QUERIES[typeof type]];
