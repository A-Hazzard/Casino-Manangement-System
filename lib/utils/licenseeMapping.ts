 ...
 */
export function getLicenseeObjectId(licenseeName: string | undefined): string | undefined {
 ...
 */
export function getLicenseeName(licenseeObjectId: string | undefined): string | undefined {
  ...
  const entry = Object.entries(LICENSEE_MAPPING).find(([_, objectId]) => objectId === licenseeObjectId);
