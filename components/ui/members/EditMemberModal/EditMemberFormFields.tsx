/**
 * Edit Member Form Fields Component
 * 
...
type EditMemberFormFieldsProps = {
  formData: {
    firstName: string;
    lastName: string;
    username: string;
...
/**
 * Edit Member Form Fields Component
 * Renders all form input fields for member editing
 */
export default function EditMemberFormFields({
  formData,
  locations,
  errors,
  checkingUniqueness,
