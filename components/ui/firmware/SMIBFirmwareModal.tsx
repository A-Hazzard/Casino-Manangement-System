  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleModalClose}>
      <DialogContent className="mx-2 flex max-h-[95vh] w-full max-w-lg flex-col overflow-hidden bg-white p-0 sm:mx-4 md:mx-0 md:max-h-[90vh]">
        <DialogHeader className="flex-shrink-0 border-b border-gray-200 p-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm text-gray-700 focus:border-buttonActive focus:ring-buttonActive"
                required
              >
            ...
            <div>
              ...
              <Input
                ...
                className="border-gray-300 text-sm focus:border-buttonActive focus:ring-buttonActive"
                required
              />
            </div>
            ...
            <div>
              ...
              <Textarea
                ...
                className="min-h-[70px] border-gray-300 text-sm placeholder-gray-400 focus:border-buttonActive focus:ring-buttonActive"
              />
            </div>
        ...
        <DialogFooter className="flex-shrink-0 flex-row justify-end space-x-2 border-t border-gray-200 bg-white p-4">
          <DialogClose asChild>
            <Button
              variant="outline"
