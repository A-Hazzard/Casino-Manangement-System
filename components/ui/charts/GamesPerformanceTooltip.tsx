/**
 * Games Performance Tooltip Component
 *
 * Custom tooltip for the games performance chart showing percentage metrics
 */
...
type GamesPerformanceTooltipProps = {
  active?: boolean;
  payload?: Array<{
    dataKey: string;
    value: number;
...
export default function GamesPerformanceTooltip({
  active,
  payload,
  label,
  coordinate,
  chartContainerRef,
}: GamesPerformanceTooltipProps) {
