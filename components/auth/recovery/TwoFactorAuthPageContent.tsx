 ...
 *
 * Manages the 2FA authenticator reset flow for vault managers.
 * Validates the recovery token from email, displays the new QR code setup,
 * and confirms the authenticator reconfiguration.
 *
 * @module components/auth/recovery/TwoFactorAuthPageContent
 */
...
export default function TwoFactorAuthPageContent() {
  // ============================================================================
  // Router & Params
  // ============================================================================
