...
export default function CollectorScheduleFilters({
  ...
  return (
    <div className="bg-buttonActive rounded-t-lg rounded-b-none p-4 flex flex-col md:flex-row md:items-center gap-2 md:gap-4 mb-0 w-full">
      <select
      ...
      <button
        className="bg-button text-white font-bold px-6 py-2 rounded-md w-full md:w-auto"
        onClick={onReset}
        disabled={loading}
      >
        Reset Filter
