...
import CollectionReportMobileEditLocationSelector from '@/components/collectionReport/mobile/CollectionReportMobileEditLocationSelector';
import CollectionReportMobileEditMachineList from '@/components/collectionReport/mobile/CollectionReportMobileEditMachineList';
          ...
          >
            ...
            <div className="flex h-full flex-col overflow-hidden">
              ...
              <div className="flex flex-1 flex-col overflow-hidden p-4">
                <CollectionReportMobileEditLocationSelector
                  locations={locations}
                  selectedLocationId={
                        lockedLocationId ||
                        selectedLocationId ||
                ...
                />
                  ...
                  <CollectionReportMobileEditMachineList
                    locationName={(() => {
