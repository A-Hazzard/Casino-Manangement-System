...
import { MachineDataEntryForm } from './MachineDataEntryForm';
...
/**
 * MobileFormPanel Component
 * Complete form panel for mobile collection modal
 */
export const MobileFormPanel: React.FC<MobileFormPanelProps> = ({
  isVisible,
  onBack,
  onViewCollectedList,
  selectedMachineData,
