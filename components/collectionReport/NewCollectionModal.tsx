 ...
 */
import NewCollectionCollectedMachines from '@/components/collectionReport/forms/NewCollectionCollectedMachines';
import NewCollectionFinancials from '@/components/collectionReport/forms/NewCollectionFinancials';
import NewCollectionFormFields from '@/components/collectionReport/forms/NewCollectionFormFields';
import NewCollectionLocationMachineSelection from '@/components/collectionReport/forms/NewCollectionLocationMachineSelection';
      ...
      <Dialog open={show} onOpenChange={handleClose}>
        <DialogContent className="flex h-[calc(100vh-2rem)] max-w-6xl flex-col bg-container p-0 md:h-[95vh] lg:h-[90vh] lg:max-w-7xl">
          ...
          <div className="flex min-h-0 flex-grow flex-row overflow-hidden">
            ...
            <NewCollectionLocationMachineSelection
            ...
            <NewCollectionCollectedMachines
              collectedMachineEntries={collectedMachineEntries}
              isProcessing={isProcessing}
