...
import LocationsCabinetGrid from '@/components/locations/LocationsCabinetGrid';
import LocationsDetailsChartSection from '@/components/locations/sections/LocationsDetailsChartSection';
...
export type LocationsDetailsCabinetsSectionProps = {
  // Data
  financialTotals: {
    moneyIn: number;
    moneyOut: number;
