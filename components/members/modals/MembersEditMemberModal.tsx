 ...
 *
 * @module components/members/modals/MembersEditMemberModal
 */
'use client';
...
import MembersEditMemberFormFields from '../EditMemberModal/MembersEditMemberFormFields';
import MembersEditMemberProfileHeader from '../EditMemberModal/MembersEditMemberProfileHeader';
import { useMembersEditMemberValidation } from '../EditMemberModal/useMembersEditMemberValidation';
import { useMembersEditMemberForm } from '../EditMemberModal/useMembersEditMemberForm';

import type { CasinoMember as Member } from '@/shared/types/entities';

export type MembersEditMemberModalProps = {
  isOpen: boolean;
  onClose: () => void;
  member: Member | null;
 ...
 * Members Edit Member Modal Component
 */
export default function MembersEditMemberModal({
  onClose,
  onMemberUpdated,
