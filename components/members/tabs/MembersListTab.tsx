      ...
      <div className="mt-4 flex w-full max-w-full items-center justify-between">
        <div className="flex w-full items-center gap-3">
          ...
          <Image
            ...
            width={32}
            height={32}
            className="ml-2 hidden h-6 w-6 sm:h-8 sm:w-8 lg:inline-block"
          />
        </div>
        {/* Add New Member button (desktop only) */}
        <Button
          onClick={handleNewMember}
          className="hidden flex-shrink-0 items-center gap-2 rounded-md bg-button px-4 py-2 text-white hover:bg-buttonActive lg:flex"
        >
