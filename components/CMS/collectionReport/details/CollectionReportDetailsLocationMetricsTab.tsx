 ...
 */
const CollectionReportDetailsLocationMetricsTab: FC<
  ...
  const sections = [
    {
      ...
      items: [
        {
          label: 'Variance',
          value: locationMetrics?.variance,
          isCurrency: true,
        },
        { label: 'Variance Reason', value: locationMetrics?.varianceReason },
        {
          label: 'Amount To Collect',
          value: locationMetrics?.amountToCollect,
          isCurrency: true,
        },
        {
          label: 'Collected Amount',
          value: locationMetrics?.collectedAmount,
          isCurrency: true,
        },
      ],
    },
      ...
      items: [
        {
          ...
          value: locationMetrics?.locationRevenue,
          isCurrency: true,
        },
        {
          label: 'Amount Uncollected',
          value: locationMetrics?.amountUncollected,
          isCurrency: true,
        },
        { label: 'Machines Number', value: locationMetrics?.machinesNumber },
        {
          label: 'Reason For Shortage',
          value: locationMetrics?.reasonForShortage,
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          label: 'Previous Balance Owed',
          value: locationMetrics?.previousBalanceOwed,
          isCurrency: true,
        },
        {
          label: 'Current Balance Owed',
          value: locationMetrics?.currentBalanceOwed,
          isCurrency: true,
        },
      ],
    },
      ...
      items: [
        {
          ...
          value: locationMetrics?.balanceCorrection,
          isCurrency: true,
        },
        {
          label: 'Correction Reason',
          value: locationMetrics?.correctionReason,
        },
      ],
    },
  ];
