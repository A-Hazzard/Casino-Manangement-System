            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-2 text-sm text-gray-600">
                  You have <span className="font-semibold">{machineCount}</span>{' '}
                  {machineCount === 1 ? 'machine' : 'machines'} with{' '}
                  <span className="font-semibold">
                    variation{machineCount === 1 ? '' : 's'}
                  </span>{' '}
                  (Total:{' '}
                  {Math.abs(totalVariation).toLocaleString(undefined, {
                    maximumFractionDigits: 2,
                  })}
                  ).
                </p>
                <p className="mt-2 text-sm text-gray-600">
                  Are you sure you want to submit the report with variations?
                  You can go back and edit the machines if needed.
                </p>
              </div>
            </div>
