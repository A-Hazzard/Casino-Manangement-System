...
export default function CollectionReportEditCollectedMachines({
  ...
  // ============================================================================
  return (
    <div className="flex h-[250px] min-h-0 w-full shrink-0 flex-col bg-gray-50 lg:h-full">
      ...
      {collectedMachineEntries.length >= 2 && (
        <div className="space-y-2 border-b border-gray-300 bg-blue-50 p-3">
          ...
          <Button
            ...
            className="mt-1 h-8 w-full bg-blue-600 text-[10px] font-bold hover:bg-blue-700"
            size="sm"
          >
