...
type ReportsPageLoadingOverlayProps = {
  isLoading: boolean;
};

type ReportsPageAuthLoadingStateProps = Record<string, never>;

type ReportsPageAccessDeniedStateProps = Record<string, never>;
