/**
 * Members Member Table Component
 *
 * Displays member information in a table format for desktop screens.
 *
 * Features:
 * - Sortable columns
 * - Point balance and occupation badges
 * - Financial metrics (Win/Loss, In/Out)
 * - Action buttons (View, Edit, Delete)
 * - Pagination controls
 *
 * @module components/members/tabs/MembersMemberTable
 */
'use client';
