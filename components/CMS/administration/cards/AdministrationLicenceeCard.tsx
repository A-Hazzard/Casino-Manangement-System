/**
 * Licencee Card Component
 * Mobile-friendly card view for displaying licencee information.
 *
 * Features:
...
type AdministrationLicenceeCardProps = {
  licencee: Licencee;
...
function AdministrationLicenceeCard({
  licencee,
  onEdit,
  onDelete,
  onPaymentHistory,
