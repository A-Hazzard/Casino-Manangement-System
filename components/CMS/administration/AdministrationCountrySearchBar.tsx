 ...
 * Search bar for filtering countries by name or code.
 *
 * Features:
 * - Text search input
...
type AdministrationCountrySearchBarProps = {
  searchValue: string;
  setSearchValue: (value: string) => void;
};

function AdministrationCountrySearchBar({
  searchValue,
  setSearchValue,
}: AdministrationCountrySearchBarProps) {
  // ============================================================================
  // Render - Search Bar
  // ============================================================================
  return (
...
export default AdministrationCountrySearchBar;
