/**
 * Add Licencee Modal Component
 * Modal for creating new licencees with country and date information.
 *
 * Features:
 * - Licencee name and description
 * - Country selection
...
type AdministrationAddLicenceeModalProps = {
  open: boolean;
  onClose: () => void;
  onSave: () => void;
  formState: {
...
function AdministrationAddLicenceeModal({
  open,
  onClose,
  onSave,
  formState,
...
}: AdministrationAddLicenceeModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      ...
      >
        ...
        <h2 className="mb-4 text-2xl font-bold">New Licencee</h2>
...
export default AdministrationAddLicenceeModal;
