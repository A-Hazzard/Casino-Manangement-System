...
function AdministrationDeleteLicenceeModal({
  open,
  onClose,
  onDelete,
  licencee,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      ...
      >
        ...
        <h2 className="mb-4 text-center text-2xl font-bold">Delete Licencee</h2>
        <p className="mb-6 text-center text-gray-700">
          Are you sure you want to delete{' '}
          <span className="font-semibold">{licencee.name}</span>?
        </p>
...
export default AdministrationDeleteLicenceeModal;
