/**
 * Licencee Search Bar Component
 * Search bar for filtering licencees by name.
 *
 * Features:
 * - Text search input
...
type AdministrationLicenceeSearchBarProps = {
  searchValue: string;
  setSearchValue: (value: string) => void;
};

function AdministrationLicenceeSearchBar({
  searchValue,
  setSearchValue,
}: AdministrationLicenceeSearchBarProps) {
  // ============================================================================
  // Render - Search Bar
  // ============================================================================
  return (
