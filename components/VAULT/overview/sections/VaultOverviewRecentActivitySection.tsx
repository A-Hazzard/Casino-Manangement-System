/**
 * Vault Overview Recent Activity Section Component
 *
 ...
 *
 * @module components/VAULT/overview/sections/VaultOverviewRecentActivitySection
 */
'use client';
...
type VaultOverviewRecentActivitySectionProps = {
...
export default function VaultOverviewRecentActivitySection({
  transactions,
}: VaultOverviewRecentActivitySectionProps) {
  // ============================================================================
  // Render
  // ============================================================================
  return (
