/**
 * Vault Overview Task Tracker Component
 *
 ...
 *
 * @module components/VAULT/overview/sections/VaultOverviewTaskTracker
 */
'use client';
...
type VaultOverviewTaskTrackerProps = {
...
export default function VaultOverviewTaskTracker({
  pendingFloats,
  pendingReviews,
  isVaultOpen,
  onViewFloats,
  onViewReviews,
  onOpenVault,
}: VaultOverviewTaskTrackerProps) {
  const tasks: VaultOverviewTaskItem[] = [
    {
      id: 'vault-status',
      title: 'Vault Status',
