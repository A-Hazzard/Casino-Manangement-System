/**
 * Vault Overview Cash Desks Section
 *
 * Displays status cards for all cashier desks.
 *
 * @module components/VAULT/overview/sections/VaultOverviewCashDesksSection
 */
'use client';

import VaultOverviewCashDeskCard from '@/components/VAULT/overview/cards/VaultOverviewCashDeskCard';
import DebugSection from '@/components/shared/debug/DebugSection';
import type { CashDesk } from '@/shared/types/vault';

type VaultOverviewCashDesksSectionProps = {
  cashDesks: CashDesk[];
  refreshing: boolean;
