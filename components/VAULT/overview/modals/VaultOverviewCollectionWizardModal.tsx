              ...
              <>
                  ...
                  <div className="flex-1 flex flex-col lg:flex-row min-h-0 bg-white overflow-hidden relative">
                      ...
                      <div className={cn(
                        ...
                        <div className="lg:hidden p-4 bg-violet-600 text-white flex items-center justify-between shrink-0">
                      ...
                      <div className={cn(
                        ...
                        <div className="p-3 border-b border-gray-100 flex items-center justify-center gap-2 bg-gray-50/30 shrink-0">
                           <Button 
