            ...
            {floats.map(float => (
              ...
              >
                ...
                <TableCell className="text-center text-xs text-gray-500">
                  {float.openedAt
                    ? new Date(float.openedAt).toLocaleTimeString([], {
                        hour: '2-digit',
                        minute: '2-digit',
                      })
                    : '-'}
          ...
          >
            <CardContent className="flex items-center justify-between gap-4 p-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="max-w-[150px] truncate font-bold text-gray-900">
                    {float.cashierName}
                  </span>
            ...
            <div className="grid grid-cols-2 gap-2 border-t bg-gray-50/50 px-4 py-3">
              ...
              <div className="flex flex-col border-l border-gray-100 pl-3">
                ...
                <span className="truncate text-xs font-bold text-orangeHighlight">
                  {formatAmount(float.payoutsTotal || 0)}
                </span>
              </div>
            </div>
