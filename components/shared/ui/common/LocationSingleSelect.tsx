  ...
  return (
    <Popover.Root open={isOpen} onOpenChange={setIsOpen}>
      <Popover.Trigger asChild>
        <Button
          variant="outline"
          className={`${buttonWidthClass} ${className} justify-between whitespace-nowrap px-3 text-left font-normal shadow-sm hover:bg-gray-50 focus:ring-2 focus:ring-blue-500/20`}
        >
      ...
      <Popover.Portal>
        <Popover.Content
          ...
          className="z-[99999] flex max-h-[60vh] flex-col overflow-hidden rounded-md border border-gray-200 bg-white shadow-xl animate-in fade-in-0 zoom-in-95"
            ...
            {includeAllOption &&
              ...
              searchTerm === '' && (
                <div className="sticky top-0 z-10 border-b border-gray-100 bg-gray-50/80 backdrop-blur-sm">
                  <div
                    className="flex cursor-pointer items-center gap-2 px-3 py-2.5 transition-colors hover:bg-white"
                  ...
                  >
                    <div className="flex-shrink-0">
                      <Checkbox
                        ...
                        className="h-4 w-4 rounded border-gray-300 data-[state=checked]:border-blue-600 data-[state=checked]:bg-blue-600"
                      />
                    </div>
                    ...
                    >
                      <div className="flex min-w-0 flex-1 items-center gap-3">
                        ...
                        <div className="flex min-w-0 flex-1 flex-col items-start gap-1">
                          <span
                            className={`whitespace-nowrap text-sm ${isSelected ? 'font-semibold text-blue-700' : 'font-medium text-gray-700'}`}
                          >
                            {option.name}
                          </span>
                          {option.sasEnabled &&
                            ...
                            showSasBadge && (
                              <Badge
                                className="h-4 border-green-200 bg-green-50 text-[9px] font-bold uppercase leading-none tracking-tighter text-green-700"
                                variant="outline"
                              >
                                SAS Connected
                              </Badge>
