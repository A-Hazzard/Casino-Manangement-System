...
import type { MachineData, MachinesOverviewTabProps } from '@/lib/types/machinesOverviewTab';
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center">
        ...
        <div className="flex-1 min-w-0 w-full md:max-w-none">
          <Input
