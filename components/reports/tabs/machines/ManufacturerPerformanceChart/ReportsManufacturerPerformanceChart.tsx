...
import ChartItemBreakdownModal from '@/components/ui/modals/ChartItemBreakdownModal';
import {
  Select,
  SelectContent,
  SelectItem,
...
export default function ReportsManufacturerPerformanceChart({
  data: initialData,
  allMachines = [],
  ...
  useEffect(() => {
    ...
    const isAllSelected = selectedFilters.includes('all-manufacturers');
    ...
    // Only auto-select all manufacturers when switching TO "All" (not when already selected)
        ...
        <div className="mb-4 space-y-3 lg:hidden">
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="all-manufacturers">
                  All Manufacturers
                </SelectItem>
                <SelectItem value="top-5-manufacturers">
                  Top 5 Manufacturers
                </SelectItem>
                <SelectItem value="bottom-5-manufacturers">
                  Bottom 5 Manufacturers
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          <div className="space-y-2">
            ...
            <ReportsManufacturerMultiSelect
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={() =>
                      handleFilterToggle('all-manufacturers')
                    }
                  />
                  <Label
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={() =>
                      handleFilterToggle('top-5-manufacturers')
                    }
                  />
                  <Label
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={() =>
                      handleFilterToggle('bottom-5-manufacturers')
                    }
                  />
                  <Label
                ...
                {aggregatedData.map(item => (
                  ...
                  >
                    <Checkbox
                      ...
                      onCheckedChange={() =>
                        handleManufacturerToggle(item.manufacturer)
                      }
                    />
                    <Label
              ...
              >
                <ResponsiveContainer width="100%" height={600}>
                    ...
                    onClick={(data: unknown) => {
                      ...
                      if (
                        ...
                        const itemData = chartData.find(
                          d =>
                            d.fullManufacturerName ===
                            payload.fullManufacturerName
                        );
                        if (itemData && itemData.totalMetrics) {
                          setSelectedItemForBreakdown({
                            name: itemData.fullManufacturerName,
                  ...
                  >
                    ...
                    <Tooltip
                      content={
                        <ReportsManufacturerPerformanceTooltip
