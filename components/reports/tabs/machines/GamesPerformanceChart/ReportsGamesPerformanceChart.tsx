...
import { ReportsGameMultiSelect } from '../GamesPerformanceRevenueChart/ReportsGameMultiSelect';
...
export default function ReportsGamesPerformanceChart({
  data: initialData,
  allMachines = [],
              ...
              >
                <ResponsiveContainer width="100%" height={600}>
                  ...
                  >
                    ...
                    <Tooltip
                      content={
                        <ReportsGamesPerformanceTooltip
