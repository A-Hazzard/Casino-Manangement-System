/**
 * Locations Revenue Analysis Tab Component
 *
 * Displays revenue analysis dashboard with location selection, metrics, charts, and revenue table
 *
 * Features:
 * - Location selection (all locations, max 3)
 * - Revenue analysis table
 * - Summary metrics cards
 * - Revenue trend charts (Money In, Win/Loss, Jackpot)
...
import ReportsLocationsRevenueTable from '@/components/reports/tabs/locations/ReportsLocationsRevenueTable';
import LocationMultiSelect from '@/components/ui/common/LocationMultiSelect';
import { ReportsLocationTrendChart } from '@/components/reports/tabs/locations/ReportsLocationTrendChart';
...
export type ReportsLocationsRevenueAnalysisProps = {
  // Data
  ...
  onExportRevenueAnalysis: (format: 'pdf' | 'excel') => void;
...
/**
 * Reports Locations Revenue Analysis Component
 */
export default function ReportsLocationsRevenueAnalysis({
  paginatedLocations,
  ...
  const displayTotals = useMemo(() => {
    ...
    const filteredLocations = paginatedLocations.filter(loc =>
      selectedRevenueLocations.includes(loc.location)
    );
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex-1">
          ...
          <p className="mt-1 text-xs text-gray-600 sm:text-sm">
            Comprehensive revenue analysis with location name, machine numbers,
            drop, cancelled credits, and gross revenue
          </p>
        </div>
        <div className="flex flex-col gap-2 sm:flex-row">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem
                onClick={() => onExportRevenueAnalysis('pdf')}
              ...
              <DropdownMenuItem
                onClick={() => onExportRevenueAnalysis('excel')}
                className="cursor-pointer"
              >
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select up to 3 locations to filter data (SAS and non-SAS locations)
          </CardDescription>
        </CardHeader>
            ...
            <div>
              ...
              {locationsLoading && allLocationsForDropdown.length === 0 ? (
                ...
                <LocationMultiSelect
                  ...
                  selectedLocations={selectedRevenueLocations}
            ...
            <div className="flex items-end sm:col-span-2 lg:col-span-1">
              <div className="w-full text-sm text-gray-600">
                {selectedRevenueLocations.length > 0
                  ? `${selectedRevenueLocations.length} location${
                      selectedRevenueLocations.length > 1 ? 's' : ''
                    } selected`
        ...
        <>
          ...
          <div className="space-y-6">
            {(() => {
              ...
              // Show message if no locations selected
                        ...
                        <table className="w-full">
                          ...
                          <tbody>
                            {topMachinesData.map((machine, index) => {
                              // Calculate floor position % (1 machine / total machines across all selected locations)
                              const totalMachines = paginatedLocations.reduce(
                                (sum, loc) => sum + (loc.totalMachines || 0),
                                0
                              );
        ...
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <div className="text-sm text-gray-400">
              Please select locations to view revenue analysis data
            </div>
          </CardContent>
        </Card>
      )}
