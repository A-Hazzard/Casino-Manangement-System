 ...
 *
 * @module components/reports/tabs/MachinesTab
 */
...
} from '@/lib/helpers/machinesTab';
import { handleExportMeters as handleExportMetersHelper } from '@/lib/helpers/reportsPage';
...
export default function MachinesTab() {
  ...
  const gamesData = useMemo(() => {
    ...
    const grouped = filteredEvaluationData.reduce(
      (acc, machine) => {
        const game = machine.gameTitle || 'Unknown';
      ...
      >
        ...
        <TabsContent value="overview">
          <MachinesOverviewTab
            ...
            onPageChange={page => setOverviewCurrentPage(page - 1)}
