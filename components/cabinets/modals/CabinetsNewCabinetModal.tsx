/**
 * Cabinets New Cabinet Modal Component
 *
 * Modal for creating a new machine/cabinet.
 *
 * @module components/cabinets/CabinetsNewCabinetModal
 */
'use client';
...
type CabinetsNewCabinetModalProps = {
  locations?: { _id: string; name: string }[];
  currentLocationName?: string;
  onCreated?: () => void;
};

export default function CabinetsNewCabinetModal({
  locations,
  currentLocationName,
  onCreated,
