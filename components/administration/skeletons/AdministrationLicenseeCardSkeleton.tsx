/**
 * Licensee Card Skeleton Component
 * Loading skeleton for licensee cards on mobile view.
 *
 * Features:
 * - Matches AdministrationLicenseeCard layout structure
 * - 5 skeleton cards
...
export function AdministrationLicenseeCardSkeleton() {
  // ============================================================================
...
export default AdministrationLicenseeCardSkeleton;
