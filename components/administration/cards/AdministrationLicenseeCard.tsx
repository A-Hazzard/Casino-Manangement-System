...
export type AdministrationLicenseeCardProps = {
  licensee: Licensee;
...
export function AdministrationLicenseeCard({
  licensee,
  onEdit,
  onDelete,
  onPaymentHistory,
  onTogglePaymentStatus,
}: AdministrationLicenseeCardProps) {
...
export default AdministrationLicenseeCard;
