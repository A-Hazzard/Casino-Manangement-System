...
export type AdministrationLicenseeTableProps = {
  licensees: Licensee[];
...
export function AdministrationLicenseeTable({
  licensees,
  onEdit,
  onDelete,
  onPaymentHistory,
  onTogglePaymentStatus,
}: AdministrationLicenseeTableProps) {
...
export default AdministrationLicenseeTable;
