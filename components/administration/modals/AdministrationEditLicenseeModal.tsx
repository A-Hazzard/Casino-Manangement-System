...
export type AdministrationEditLicenseeModalProps = {
  open: boolean;
  onClose: () => void;
  onSave: () => void;
  formState: {
...
export function AdministrationEditLicenseeModal({
  open,
  onClose,
  onSave,
  formState,
...
}: AdministrationEditLicenseeModalProps) {
...
export default AdministrationEditLicenseeModal;
