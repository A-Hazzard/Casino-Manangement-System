...
function LoginForm() {
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    if (!validateEmail(emailAddress)) {
      setErrors((prev) => ({
        ...prev,
        emailAddress: "Invalid email address address.",
      }));
      return;
    }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-[#F6B37F]/40 via-[#5A69E7]/40 to-[#96E3D4]/40">
      <motion.div
      ...
      >
        ...
        <form onSubmit={isForgot ? handleForgotPassword : handleLogin}>
          ...
          >
            {loading ? "Please wait..." : isForgot ? "Reset Password" : "Login"}
          </button>
        </form>
