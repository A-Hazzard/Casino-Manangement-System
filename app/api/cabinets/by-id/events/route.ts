 ...
 * @param {string} eventType - Filter by event category name
 * @param {string} type - Filter by log level ('Warning', 'Error', 'Info')
 * @param {string} event - Search query for event description
 * @param {string} game - Filter by game name
 * @param {string} timePeriod - Time range preset ('Today', 'Yesterday', '7d', '30d', 'LastHour')
