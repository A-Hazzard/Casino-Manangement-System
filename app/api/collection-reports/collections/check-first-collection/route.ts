 ...
 *
 * @module app/api/collection-reports/collections/check-first-collection/route
 */
 ...
 *
 * @param {string} machineId - REQUIRED. Query param: The MongoDB ID of the machine to check
 *
 * Flow:
