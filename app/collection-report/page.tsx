...
function CollectionReportContent() {
  ...
  return (
    <>
      ...
      >
        <div
          className="mt-4 flex w-full max-w-full flex-col items-start justify-between gap-3 sm:flex-row sm:items-center sm:gap-0"
          ...
          {activeTab === 'collection' && (
            <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:gap-3">
              <Button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-md bg-buttonActive px-3 py-2 text-xs font-medium text-white transition-colors hover:bg-purple-700 sm:w-auto sm:justify-start sm:px-4 sm:text-sm"
              >
                <svg
                  className="h-4 w-4"
                  fill="none"
